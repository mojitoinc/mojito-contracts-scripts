 ...
 */
abstract contract ERC1155ClaimRedeem is
    ReentrancyGuard,
    ERC1155RedeemBase,
    IERC1155ClaimRedeem
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC1155RedeemBase, IERC165)
        returns (bool)
    {
        return
            interfaceId == type(IERC1155ClaimRedeem).interfaceId ||
        ...
        adminRequired
    {
        ...
        uris[0] = uri;
        _redemptionTokenId = IERC1155CreatorCore(_creator).mintExtensionNew(
            receivers,
            amounts,
            uris
        )[0];
     ...
     */
    function updateURI(string calldata uri)
        external
        virtual
        override
        adminRequired
    {
        ...
        IERC1155CreatorCore(_creator).setTokenURIExtension(
            _redemptionTokenId,
            uri
        );
    }
    ...
    function redeemable(address contract_, uint256 tokenId)
        ...
        view
        virtual
        override(RedeemBase, IRedeemBase)
        returns (bool)
    {
