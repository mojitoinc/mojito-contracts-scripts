 ...
 */
abstract contract ERC721RedeemSetBase is
    ERC721SingleCreatorExtension,
    RedeemSetBase,
    CreatorExtension,
    IERC721RedeemSetBase
{
    ...
    constructor(
        address creator,
        RedemptionItem[] memory redemptionSet,
        uint16 redemptionMax_
    ) ERC721SingleCreatorExtension(creator) {
        require(
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(RedeemSetBase, CreatorExtension, IERC165)
        returns (bool)
    {
        return
            interfaceId == type(IERC721RedeemSetBase).interfaceId ||
            RedeemSetBase.supportsInterface(interfaceId) ||
