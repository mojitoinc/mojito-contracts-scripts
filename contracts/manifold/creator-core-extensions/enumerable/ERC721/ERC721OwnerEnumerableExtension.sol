...
import "../../../creator-core/extensions/ERC721/ERC721CreatorExtensionApproveTransfer.sol";
 ...
 */
abstract contract ERC721OwnerEnumerableExtension is
    ERC721CreatorExtensionApproveTransfer
{
    mapping(address => mapping(address => uint256))
        private _creatorOwnerBalance;
    mapping(address => mapping(address => mapping(uint256 => uint256)))
        private _creatorTokensByOwner;
    ...
    function tokenOfOwnerByIndex(
        ...
        require(
            index < _creatorOwnerBalance[creator][owner],
     ...
     */
    function balanceOf(address creator, address owner)
        public
        view
        virtual
        returns (uint256)
        ...
        private
    {
        ...
        if (tokenIndex != lastTokenIndex) {
            uint256 lastTokenId = _creatorTokensByOwner[msg.sender][from][
                lastTokenIndex
            ];
