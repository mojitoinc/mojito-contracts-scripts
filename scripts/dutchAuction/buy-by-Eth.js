...
async function main() {
  ...
  const auctionContractAddress = "0xdEB93a6d82206A9e65b45f61E008b77F35f005Ac";
  // Dutch Utility contract Address 
  const auctionUtilityAddress = "0x502cD781ba27f8de47E45e571F64dbDfbfeE5A00";    
  ...
  const quantity = 2;                                                    // token count to buy    
  const price = currentPrice.mul(totalBuytoken);                       // calcualted Buying amount based on current price and no of tokens
  const tax = 0;                                                              // tax of buying Amount.
  const unit1155 = 0;                                                         // Quantity should be zero for ERC721
