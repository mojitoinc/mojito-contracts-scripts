...
async function main() {
    ...
    // Place the Payment contract address
    const payableToken = "0x54FA517F05e11Ffa87f4b22AE87d91Cec0C2D7E1";
    // Place the signer of the Seller Signature
    const sellerSigner = "0x698C2F5E4b29C90A78eF69DBED39C1c826c99c60";
    // Place the Bid History
    const bidHistory = [
        ["0xacd73aBb13630a142aD44d8f75fB7c0309fe80e8", ethers.utils.parseUnits("0.1", "ether"), ethers.constants.AddressZero],
        ["0xacd73aBb13630a142aD44d8f75fB7c0309fe80e8", ethers.utils.parseUnits("0.1", "ether"), ethers.constants.AddressZero],
    ];
    ...
    // call to executeAuction
    let receipt = await MarketPlace.executeAuction(
        Order,
        sellerSignature,
        buyerSignature,
        payableToken,
    ...
    console.log(`\n transaction hash of executeAuction, tx hash: ${receipt.hash}`);
