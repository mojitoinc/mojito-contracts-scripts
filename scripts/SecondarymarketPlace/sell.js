...
async function main() {
    ...
    // Place the buyer Signature
    const buyerSignature = "0x6ceaf723880f328fcf6b8d08ec74e0745225119cef85b499c449e1ed9f3992a6432bd1c558c7c1f9b206361e3755fd5aeeb2f498c058592dc02fd857a8d177131c";
    // place expiration time 
    const expirationTime = "0x54FA517F05e11Ffa87f4b22AE87d91Cec0C2D7E1";
    // Place the receivable token contract address
    const receivableToken = "0x54FA517F05e11Ffa87f4b22AE87d91Cec0C2D7E1";
    // Place Payment settlement address
    const paymentSettlementAddress1 = "0xacd73aBb13630a142aD44d8f75fB7c0309fe80e8";
    ...
    // call to sell the token(s)
    let receipt = await MarketPlace.sell(
        Order,
        buyerSignature,
        expirationTime,
        receivableToken,
        paymentSettlementAddress1
    );

    console.log(`\n transaction hash of sell, tx hash: ${receipt.hash}`);
